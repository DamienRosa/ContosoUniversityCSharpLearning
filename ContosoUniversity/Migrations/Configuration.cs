namespace ContosoUniversity.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<ContosoUniversity.DAL.SchoolContext>
    {
        ...
        protected override void Seed(ContosoUniversity.DAL.SchoolContext context)
        {
            ...
            {
                new Instructor { FirstMidName = "Kim", LastName = "Abercrombie", HireDate = DateTime.Parse("12-07-06")},
            ...
            departments.ForEach(d => context.Departments.AddOrUpdate(u => u.Name, d));
            context.SaveChanges();
            ...
            {
                var enrollmenteDateBase = context.Enrollments.Where(
                        s => s.Student.ID == en.StudentID && s.Course.CourseID == en.CourseID).SingleOrDefault();
                if (enrollmenteDateBase == null)
                {
            ...
            officeAssigments.ForEach(o => context.OfficeAssignments.AddOrUpdate(p => p.InstructorID, o));
            context.SaveChanges();
